	...
	<section id="container">
		...
		<div class="container" style="width: 500px">
			...
			<article class="card-body" style="width: 500px">
				...
				<form action="joinformOk.ump" method="post" name="joinform"
					id="joinform">
					...
					<div class="form-group">
						<label><strong>아이디</strong></label>
							<div class="row">
							 ...
							 <span class="idcheck hide" ></span>
						</div>
					

					<div class="form-group">
						<label><strong>비밀번호</strong></label> 
						<input class="form-control" placeholder="****" type="password" name="pwd" id="pwd">
						<span class="password hide" ></span>
					</div>

					<div class="form-group">
						<label><strong>비밀번호 확인</strong></label> 
						<input class="form-control" placeholder="****" type="password" name="pwdc" id="pwdc">
						<div id="message" ></div>
					</div>

					<div class="form-group">
						<label><strong>이름</strong></label>
						<input class="form-control" placeholder="홍길동" type="text" name="mname" id="mname">
					...
					<div class="form-group">
						...
						<input class="form-control" placeholder="123@gmail.com" type="text" name="email" id="email">
					...
					<input type="text" id="sample6_postcode" name="sample6_postcode"
						...
						placeholder="상세주소" class="form-control mb-3">

					<div class="form-group">
						<label><strong>핸드폰 번호(- 제외)</strong></label> 
						<input class="form-control" placeholder="01012345678" type="text" name="pnum" id="pnum">
