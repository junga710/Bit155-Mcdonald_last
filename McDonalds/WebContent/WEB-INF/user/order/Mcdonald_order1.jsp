...
<body>
	...
	<div class="container show-grid">
		<div class="row" style="border-radius: 70px;">
			<div class="col-md-2" style="background-color:white;"></div>
			<div class="col-md-10"><h4><b>메뉴</b></h4></div>
		</div>
		<div class="row">
			<div class="col-md-2" style="background-color:white;">
				<div class="btn-group-vertical" style="width: 99%;">
					<button type="button" class="btn btn-warning"
						style="border-bottom: 1px solid darkblue;"><b>메뉴</b></button>
					<button id="burgerButton"  type="button" class="btn btn-warning"
						style="border-top: 2px solid black;" value="버거">버거 &
						세트</button>
