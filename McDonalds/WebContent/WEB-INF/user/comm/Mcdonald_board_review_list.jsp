 ...
 <jsp:include page="/user/header.jsp"></jsp:include>
     ...
     <div class="container">
        <div class="row  mt-5">
     	  ...
     	  <button class="btn btn-warning" role="button" ><strong>글쓰기</strong></button>
     </div>	  
   </div>
            ...
            <div class="col">
               <div class="card-deck">
                  <div class="card-body" style="width:380px">
                     ...
                     <img class="card-img-top" src="../vendors/images/card/1587529214177.png"
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="card-body text-reft" style="width:380px">
                           <img class="card-img-top" src="../vendors/images/card/1585129454903.png"
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="card-body text-reft" style="width:380px">
                           <img class="card-img-top" src="../vendors/images/card/1588122162048.png"
      ...
      <div class="container" >
         <div class="row">
            <div class="col">
               <div class="card-deck">
                  <div class="card-body" style="width:380px">
                     <img class="card-img-top" src="../vendors/images/card/1579235808560.png"
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <div class="row">
               <div class="col">
                  <div class="card-body text-reft" style="width:380px">
                     <img class="card-img-top" src="../vendors/images/card/1564021259329.png"
