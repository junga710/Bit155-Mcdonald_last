...
<body>
	...
	<div class="row mt-5">
		...
		<div class="col-1">
			<div id="productli">
				<a href="MenuBurger.um" role="button" style="color: #808080;">단품메뉴</a>
			</div>
...
var mybutton = document.getElementById("myBtn"); // When the user
...
document.documentElement.scrollTop > 20) { mybutton.style.display =
"block"; } else { mybutton.style.display = "none"; } } // When the user
clicks on the button, scroll to the top of the document function
