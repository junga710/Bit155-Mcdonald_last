						...
						<div class="col-4">
							...
							<!-- 	<div class="card-header">
								...
								<div class="card-body card-block">
									<form action="MemberUpdate.m" method="post"
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="m_id" name="m_id"
													value="${memberDTO.m_id}" readonly class="form-control">
											</div>
										</div>
										<div class="row form-group">
											<div
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="name" name="name"
													value="${memberDTO.name}" class="form-control">
											</div>
										</div>
										<div class="row form-group">
											<div
											...
											<div class="col-12 col-md-9">
												<input type="email" id="email" name="email"
													value="${memberDTO.email}" class="form-control">
											</div>
										</div>
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-6">
												<input type="text" id="post_code" name="post_code"
													value="${memberDTO.post_code}" class="form-control">
											</div>
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="address" name="address"
													value="${memberDTO.address}" class="form-control">
											</div>
										</div>
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="address_detail" name="address_detail"
													value="${memberDTO.address_detail}" class="form-control">
											</div>
										</div>
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="text" id="phone" name="phone"
													value="${memberDTO.phone}" class="form-control">
											</div>
										</div>
								</div>
								<div class="card-footer">
									...
									<a href="#" type="button" class="btn btn-danger btn-sm"> <i
										class="fa fa-dot-circle-o"></i> 초기화?
									</a>
								</div>
								</form>
							</div>
