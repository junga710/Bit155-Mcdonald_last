						...
						<div class="col-8">
							...
							<!-- 	<div class="card-header">
											...
											<div class="row form-group">
												<div id="outer"
													...
													<div class="col-12 col-md-9 ">
														<img id="preview" src="vendors/images/DB_images/default.png"
															width="200" alt="사진을 등록해주세요."
											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-9">
													<input style="width: 300px;" type="text" id="product_code"
														name="product_code" value="${product_code}" readonly class="form-control">
												</div>
											</div>
								...
								<div class="card-footer">
									...
									<%--  <a
										href="ProductDelete.p?product_code=${productDto.product_code}&nutrition_code=${nutritionDto.nutrition_code}"
