...
public class ReviewDetailService implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		//정아누나꺼~
		/*
		 * System.out.println("상세페이지 서블릿 타나요"); String n_codestr =
		 * request.getParameter("n_code"); int n_code =
		 * Integer.parseInt(n_codestr.trim());
		 * 
		 * UserDAO userDao = new UserDAO(); BoardNoticeDTO boardNoticeDTO =
		 * userDao.BoardNoticeDetail(n_code);
		 * 
